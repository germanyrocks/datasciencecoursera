...
par(mfrow=c(2,2))
plot( power$dtm, y =as.numeric(power$Global_active_power)/500, type ='l', ylab = 'Global Active Power (kilowatts)', xlab= '') 
plot( power$dtm, y =power$Voltage, type ='l', ylab = 'Voltage', xlab ='datetime') 
...
plot( power$dtm, y =power$Global_reactive_power, type ='l', ylab = 'Global_reactive_time', xlab ='datetime') 
dev.off()